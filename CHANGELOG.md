...
## [14.0.0](https://github.com/lslavkov/initiative-tracker/compare/v13.0.16...14.0.0) (2024-12-12)
...
* Add Dnd 5e 'Flee, Mortals!' XP System ([#248](https://github.com/lslavkov/initiative-tracker/issues/248)) ([761375c](https://github.com/lslavkov/initiative-tracker/commit/761375c3032f77bfca08e09ae789018b597ec6c6))
* Add DnD 5e Cr2.0 Simple XP Calculation System ([#230](https://github.com/lslavkov/initiative-tracker/issues/230)) ([f369cad](https://github.com/lslavkov/initiative-tracker/commit/f369cad6171e16ac00ef128511cc49cdea156229))
* Adds Editor Suggestor for encounter blocks (close [#185](https://github.com/lslavkov/initiative-tracker/issues/185)) ([012b1eb](https://github.com/lslavkov/initiative-tracker/commit/012b1eb4c3f95eaa1547ddfe59a66d0b587f7228))
* Adds the Lazy GM additional difficulty calculation method + a scaffold for future difficulty methods. ([2c39c7b](https://github.com/lslavkov/initiative-tracker/commit/2c39c7b29e84d7ec7193887474783ace3c206c91))
* Basic API started ([a136eb1](https://github.com/lslavkov/initiative-tracker/commit/a136eb1ee5bb812f342520d463905be33d3e2d75))
* Can now change how Player initiatives are rolled in the Tracker controls ([4fe45ff](https://github.com/lslavkov/initiative-tracker/commit/4fe45ff63a3774db1449be8aff7ec886e8fc8a96))
* Can now sort initiatives by descendig or ascending ([#68](https://github.com/lslavkov/initiative-tracker/issues/68)) ([079b59c](https://github.com/lslavkov/initiative-tracker/commit/079b59c8a5d24bca96eb9ca1ab0cf1c8cda2afa1))
* Can now specify initiative as static (close [#74](https://github.com/lslavkov/initiative-tracker/issues/74)) ([b602f5c](https://github.com/lslavkov/initiative-tracker/commit/b602f5c790df097fcd4f2482d52ce36d7b28ab77))
* Commands will now be registered to start each saved encounter ([15887b0](https://github.com/lslavkov/initiative-tracker/commit/15887b0748250558af55d2ba6ba8dd6db874c9a9))
* Copy encounter string to clipboard in Builder (close [#207](https://github.com/lslavkov/initiative-tracker/issues/207)) ([360ca03](https://github.com/lslavkov/initiative-tracker/commit/360ca03aa19ae500296be38e1bfc21905193a777))
* Creatures set as a player from Fantasy Statblocks now treated as players ([cda408b](https://github.com/lslavkov/initiative-tracker/commit/cda408b74b46dcd04b263bf389bc916e362cf184))
* Encounter Builder Custom Filters ([0146f8a](https://github.com/lslavkov/initiative-tracker/commit/0146f8af80343379aaf1cf5a15f77cfccdf8c31d))
* Load saved encounters into builder ([de7181c](https://github.com/lslavkov/initiative-tracker/commit/de7181cdfab548179a5848a065dad9a31c6c22a0))
* PF2e Encounter Building Rules ([618c78d](https://github.com/lslavkov/initiative-tracker/commit/618c78d82a6f48b021519696f4abe902da4f336e))
* **publish:** Added Creature as Player Images ([481a221](https://github.com/lslavkov/initiative-tracker/commit/481a22165679ab084955f1e8dde981d246d436f7))
* **publish:** Added Creature as Player Images ([c4d09d5](https://github.com/lslavkov/initiative-tracker/commit/c4d09d5f3080d82afe134300ee86439179063260))
* Removed 5e SRD from Initiative Tracker ([260abfc](https://github.com/lslavkov/initiative-tracker/commit/260abfcc81b28fae1232a8600496c1f3c624056a))
* Switch to Fantasy Statblocks API ([a993447](https://github.com/lslavkov/initiative-tracker/commit/a993447c948596f59e3a426bb4dc824ba4625dfd))
* switch to new Fantasy Statblocks API ([28c8363](https://github.com/lslavkov/initiative-tracker/commit/28c836321dd5432f8c830b4c5a2c1a8ddeb7229f))
* This removed the feature of Leaflet integration. However, this feature has been broken. ([ad30f98](https://github.com/lslavkov/initiative-tracker/commit/ad30f98d28b083249de5cbd5b03e335346d7e963))


### Bug Fixes

* :bug: Correctly number first instance of a creature when adding more ([6424b23](https://github.com/lslavkov/initiative-tracker/commit/6424b2312432662b377548a7107a7f09b48e81f3))
* `updateCreatureByName` accepts a status array now ([7e8cf1f](https://github.com/lslavkov/initiative-tracker/commit/7e8cf1fd3c0847e32879cadaa57d88286679e3b4))
* 🐛 Improves grouped creature initiative rolling logic ([97cd5e7](https://github.com/lslavkov/initiative-tracker/commit/97cd5e78624a1595f2c5f3e0ef7a26e9cfbf55f3))
* 🚸 Adds "Roll Initiative" button to Tracker table ([61fbe47](https://github.com/lslavkov/initiative-tracker/commit/61fbe47bfa7506de4e164f2d5d9fac20dd0b0f01))
* actually remove side effects from updateCreatureByName ([cf8bf9f](https://github.com/lslavkov/initiative-tracker/commit/cf8bf9f806aa0693b3a00551cc9ee53d8ed0d57b))
* add `false` as an option for parties ([0651b84](https://github.com/lslavkov/initiative-tracker/commit/0651b84fd4d55484ea5f16459f649030d2cd1263))
* adds updateCreatureByName tracker method ([94396a2](https://github.com/lslavkov/initiative-tracker/commit/94396a2f3822e97fd29b277f019ecc3bdea1d333))
* Allow negative initiatives ([7c6eb4c](https://github.com/lslavkov/initiative-tracker/commit/7c6eb4c849916f4f4a9b39217e2a7987521d2967))
* beep boop ([bf9cc08](https://github.com/lslavkov/initiative-tracker/commit/bf9cc08fefd71ed58f4f8e94b7b211eb56301a45))
* Can set party to None in tracker menu ([268b661](https://github.com/lslavkov/initiative-tracker/commit/268b66108e90dc615e22c50d9b697784f04974ed))
* Changes to players sync back to linked notes (close [#176](https://github.com/lslavkov/initiative-tracker/issues/176)) ([40da2d3](https://github.com/lslavkov/initiative-tracker/commit/40da2d3492f9b7745130cb5b415eaeb23afeddfe))
* Check for Statblock-style links and transform them before parsing the `statblock-link` property ([8bc3ae5](https://github.com/lslavkov/initiative-tracker/commit/8bc3ae56bee16176e209c2e70b734e39f1285154))
* Confirm to overwrite saved encounters ([be070ee](https://github.com/lslavkov/initiative-tracker/commit/be070eeed6a6ff872c3c20c2ab40c61e69edbe67))
* correctly retrieve creatures from bestiary in encounters ([195d871](https://github.com/lslavkov/initiative-tracker/commit/195d871186d6fcd9fa12b109fd3fb3031ced8204))
* Creature difficulty now won't display if CR is not present ([a1079c4](https://github.com/lslavkov/initiative-tracker/commit/a1079c4c3ff57c91bfd75e8a062ec42ff3a76bb8))
* Creature hidden state no longer reset with HP / Status ([e88b468](https://github.com/lslavkov/initiative-tracker/commit/e88b468cd7c7276b7d6f8d2e832a862c03c1abf3))
* Creatures not in bestiary now render correctly in Combatant ([cebb672](https://github.com/lslavkov/initiative-tracker/commit/cebb672bedbce29cb8208d2dc9a7afdb33d276d2))
* Creatures will roll for HP correctly when added through the UI ([e6198f1](https://github.com/lslavkov/initiative-tracker/commit/e6198f1272f20bdf9c5096a37b56c3536b48325a))
* Creatures with HP specified will no longer roll HP ([8790517](https://github.com/lslavkov/initiative-tracker/commit/8790517f88d3f94e38e4477579e291a3bfcb81b7))
* decimal crs now pull xp correctly (close [#190](https://github.com/lslavkov/initiative-tracker/issues/190)) ([e293e78](https://github.com/lslavkov/initiative-tracker/commit/e293e78a2329ba3067ad35e00c38c9f37c23da40))
* Difficulty displays will now update when XP system is changed ([03f786d](https://github.com/lslavkov/initiative-tracker/commit/03f786d5db05314cd6893b67224060aaa5a06740))
* Display friendly state in Player View ([c3ff665](https://github.com/lslavkov/initiative-tracker/commit/c3ff6652e4ba92f4b9c956ebf2b99b522b7076e9))
* Display saved encounters in settings ([bcb9e14](https://github.com/lslavkov/initiative-tracker/commit/bcb9e14c6a2ecc415dfea5adafecaded9d354e63))
* do not open creature suggester immediately when editing a creature ([4340370](https://github.com/lslavkov/initiative-tracker/commit/434037050a43a003827998ae2f45071ccaffa94d))
* Encounter blocks will less greedily add the default party if players are explicitly defined ([eb4a59a](https://github.com/lslavkov/initiative-tracker/commit/eb4a59a5d1becda8ba659abe6238e0470ae7d987))
* Encounter Builder encounters will save between reloads ([dca66ab](https://github.com/lslavkov/initiative-tracker/commit/dca66abb23c302d84a00c9f6e72d2c9db35ec8bd))
* Encounter builder supports hidden and friendly creatures ([20d2ee7](https://github.com/lslavkov/initiative-tracker/commit/20d2ee77a2283d03217ca421b26ef62c7d81e087))
* Encounters copied from the Encounter Builder no longer include disabled players in the output (close [#265](https://github.com/lslavkov/initiative-tracker/issues/265)) ([fd045ac](https://github.com/lslavkov/initiative-tracker/commit/fd045ac75bf9acf731bf3876cac9f757191e48ec))
* Encounters now allow creatures to be set to zero ([f9b5f6c](https://github.com/lslavkov/initiative-tracker/commit/f9b5f6cfba6e5234f0b570139a7a19ed079b3492))
* Encounters pull FS creatures correctly ([0db3845](https://github.com/lslavkov/initiative-tracker/commit/0db3845fdc68344828e80ab45cd53a6977a766de))
* Encounters saved from builder now roll initiatives correctly ([50e9281](https://github.com/lslavkov/initiative-tracker/commit/50e9281abafa2a53b003230abecbc8dc16771aec))
* expose tracker as temporary API ([48d7a1c](https://github.com/lslavkov/initiative-tracker/commit/48d7a1cb96b70144553afe2af138b9ac8e73cb13))
* fix error caused by no player level being set ([d8639ec](https://github.com/lslavkov/initiative-tracker/commit/d8639ec667a8ad44c1a025b96e4b2d46a4bcde82))
* Fixes `updateCreatureByName` ([4d36f25](https://github.com/lslavkov/initiative-tracker/commit/4d36f25a3d98aa46fd5eb4472b12d522909061aa))
* fixes bug preventing adding players via the "Add Creature" button ([#197](https://github.com/lslavkov/initiative-tracker/issues/197)) ([3e5cc4d](https://github.com/lslavkov/initiative-tracker/commit/3e5cc4d7c7fc55ca42195ce7d794e5f6e74b8b83))
* Fixes Condition suggester not appearing ([aa2384b](https://github.com/lslavkov/initiative-tracker/commit/aa2384b75c60c524c889a212204db8406f8a8ef1))
* fixes display of suggestor for Obsidian 1.4+ ([1ba2348](https://github.com/lslavkov/initiative-tracker/commit/1ba234815af3bb092b9d04bbd9fb9b7c01808337))
* Fixes error where values specified as a list in a creature were not being filtered correctly in the encounter builder ([a395715](https://github.com/lslavkov/initiative-tracker/commit/a3957151c2e041bbf62607cade6a3a0c335ed616))
* fixes highlighting in creature suggester ([ee5f812](https://github.com/lslavkov/initiative-tracker/commit/ee5f812c204aeee55b25e92cbf4d31734a25aea7))
* fixes incorrect variable name reference (close [#200](https://github.com/lslavkov/initiative-tracker/issues/200)) ([f45be61](https://github.com/lslavkov/initiative-tracker/commit/f45be6143c9431fa8c281cfe7cd212f10b669da2))
* Fixes issue preventing encounter builder filters to open if an Options filter was present ([d2a5c03](https://github.com/lslavkov/initiative-tracker/commit/d2a5c03f046d84cbc1accee97032572231bcc77a))
* Fixes issue preventing encounters containing dice rollers from rendering ([68f3de7](https://github.com/lslavkov/initiative-tracker/commit/68f3de7d1021328b67268174594b236c26adc23a))
* fixes issue where levels other than 1-20 caused encounter calculation errors ([4599fc6](https://github.com/lslavkov/initiative-tracker/commit/4599fc64c8b543dd13e99b2f60d6f653382e7e55))
* Fixes issue where the encounter builder ribbon icon could cause the plugin to not load ([6534c87](https://github.com/lslavkov/initiative-tracker/commit/6534c8711fc03a7ca905d774b94cdb62bcf26fbe))
* Fixes issue with deleting saved encounters ([75c8664](https://github.com/lslavkov/initiative-tracker/commit/75c8664bb68baea64a89d90e738ba1e17b713ad8))
* Fixes issue with Dice Roller integration (close [#232](https://github.com/lslavkov/initiative-tracker/issues/232)) ([3888416](https://github.com/lslavkov/initiative-tracker/commit/3888416b4527c4f27c90854b3261897bc5373c94))
* Fixes issues with deleting encounters from settings ([69a9d94](https://github.com/lslavkov/initiative-tracker/commit/69a9d94385580c7ba1a8fa78cdaad47458f1e95a))
* Fixes IT menus on mobile ([bfb2312](https://github.com/lslavkov/initiative-tracker/commit/bfb23123445362eb37010276729009adbfeddadd))
* Fixes load encounter submenu on mobile ([e6f33ac](https://github.com/lslavkov/initiative-tracker/commit/e6f33ac64ef532de5c894930cc4626bd26d67a2b))
* fixes party level calculation for pf2e system ([005f7ec](https://github.com/lslavkov/initiative-tracker/commit/005f7ec1b40e5eeb637e562a9a5d8738ce89c990))
* Fixes PF2e system difficulty threshold calculation ([bc8ebad](https://github.com/lslavkov/initiative-tracker/commit/bc8ebad7fa458dec34fbca733ba06adb1c5527c3))
* Fixes player display in settings ([5336fef](https://github.com/lslavkov/initiative-tracker/commit/5336fef4102b9f500be63d503f9fee59387e3388))
* Fixes reset filters to default ([de9a394](https://github.com/lslavkov/initiative-tracker/commit/de9a3942f67611bb2111829d013fb82670c6ad98))
* fixes rolling dice for array-based modifiers (close [#196](https://github.com/lslavkov/initiative-tracker/issues/196)) ([e489766](https://github.com/lslavkov/initiative-tracker/commit/e48976659b5065b2818b7e2644b2b7a6ffa83b7e))
* fixes saving players sometimes duplicating ([c8c2a9b](https://github.com/lslavkov/initiative-tracker/commit/c8c2a9bf91e09fac4c75126ebc9df49eab8da936))
* fixes setting max hp from notes ([300860d](https://github.com/lslavkov/initiative-tracker/commit/300860d38b729bd408360b99c8b5fbb4b4251405))
* Fixes status descriptions displaying "null" if no description was set ([d1c44f6](https://github.com/lslavkov/initiative-tracker/commit/d1c44f625c2d7f57d66319336e010fce6b53979f))
* Fixes Statuses not being logged correctly when starting a log file ([82a8faf](https://github.com/lslavkov/initiative-tracker/commit/82a8faf42b851500a584a1ea47889c1f7703b163))
* fully remove leaflet support (for now) ([51aed21](https://github.com/lslavkov/initiative-tracker/commit/51aed212bd1126331dcc3e91f3d6c3f2f475082a))
* getting a player by name now returns a creature if no player exists ([0549522](https://github.com/lslavkov/initiative-tracker/commit/054952278eb92fda243eea498ac598ed0c44d5d1))
* handle players added directly in encounters, not just through parties ([#197](https://github.com/lslavkov/initiative-tracker/issues/197)) ([4317e07](https://github.com/lslavkov/initiative-tracker/commit/4317e0741b707fee2b54627beb82666d5e9b8392))
* If an existing player view is found, reveal it ([2dda097](https://github.com/lslavkov/initiative-tracker/commit/2dda0978fe38cba9f7cdc82e0eff144ad104181b))
* Ignore creatures from FS that shouldn't be in bestiary. ([77d048d](https://github.com/lslavkov/initiative-tracker/commit/77d048d793c94f6d4b0d0cf332deeb1f943c727a))
* ignore null player levels when finding daily budget ([48dc637](https://github.com/lslavkov/initiative-tracker/commit/48dc63750dc6046be1fbd6db8b3fcbc7e074a5c2))
* Improves Add Creature experience on mobile ([5a20e10](https://github.com/lslavkov/initiative-tracker/commit/5a20e105f74079ce271ccf3a63e0c4546d71555c))
* Improves Fantasy Statblocks bestiary resolution behavior ([a1a3d07](https://github.com/lslavkov/initiative-tracker/commit/a1a3d075c973953202c611fdb22b9979215105f6))
* improves player management in settings ([169cc7d](https://github.com/lslavkov/initiative-tracker/commit/169cc7d6c3ae564e96a007728f4f5e2d631cacf2))
* **issues:** Typo Fix ([d2dc915](https://github.com/lslavkov/initiative-tracker/commit/d2dc9153111b02f8ca7e2763f9a0b6568b32802f))
* **issues:** Typo Fix ([7347187](https://github.com/lslavkov/initiative-tracker/commit/734718755e938f500be916f8a7c27c077297c609))
* Load encounters disabled when no encounters exist ([06b1a45](https://github.com/lslavkov/initiative-tracker/commit/06b1a452651fba6d995f12c69498af02a9f19eeb))
* No longer unload views when plugin is unloaded ([fedc639](https://github.com/lslavkov/initiative-tracker/commit/fedc6397c9b2f49477fb0bb1f557778c9e16794f))
* Normalize derived options in Encounter Builder options filters ([27c4d92](https://github.com/lslavkov/initiative-tracker/commit/27c4d92fc7e95e4ae10502dc17744b0931822c55))
* Notify users of new FS version requirement. ([9ea056e](https://github.com/lslavkov/initiative-tracker/commit/9ea056e93fc379623b5bed191bc96a482ce96ba8))
* only include player levels in encounter if they are a number ([3fb298f](https://github.com/lslavkov/initiative-tracker/commit/3fb298f81bd3c2a1e0a450d4f76a3919d22a89d8))
* Only set difficulty if the highest threshold is &gt; 0 ([#197](https://github.com/lslavkov/initiative-tracker/issues/197)) ([11c3db7](https://github.com/lslavkov/initiative-tracker/commit/11c3db755da187703b28ed503c75226750f15287))
* Party size is now taken into account when calculating 5e difficulties ([9e8bdde](https://github.com/lslavkov/initiative-tracker/commit/9e8bdde5f86de9fcd294ed3ed4f819636f4465d3))
* Plugin will now properly save encounters immediately from the builder ([daa8ce2](https://github.com/lslavkov/initiative-tracker/commit/daa8ce2f33b85e7f06734948f9cb3777657ada42))
* Properly check for settings being initialized in the tracker before attempting to access data ([e7b4bd2](https://github.com/lslavkov/initiative-tracker/commit/e7b4bd242ea4cdecc7098b75032d183ee5c53a9f))
* Properly unload FS resolve event ([17aa794](https://github.com/lslavkov/initiative-tracker/commit/17aa79472190defcf684fb333fea852b9ccce694))
* remove AC from player view ([c6ecb19](https://github.com/lslavkov/initiative-tracker/commit/c6ecb19cfbf0f39fc3e264b3e9bf5c41d480c019))
* remove logs ([f84a61c](https://github.com/lslavkov/initiative-tracker/commit/f84a61c1433752164022fa5d91c8c7df9cbcee91))
* Remove obsidian-overload package ([775fe52](https://github.com/lslavkov/initiative-tracker/commit/775fe523d0717708bbad329d2c8ce50890dbbf3c))
* removed logs ([21a6acc](https://github.com/lslavkov/initiative-tracker/commit/21a6acc5f364409baa18a69d803fbc14e1c99289))
* Removes legacy creator option ([d8f6cdb](https://github.com/lslavkov/initiative-tracker/commit/d8f6cdb2b31fd2b0cf88e7e449079bab8fd21916))
* removes logs ([ca9b95f](https://github.com/lslavkov/initiative-tracker/commit/ca9b95f3392482fa142a9a60f6b20e5ea12780db))
* Removes outdated message about Fantasy Statblocks compatibility ([8e85b58](https://github.com/lslavkov/initiative-tracker/commit/8e85b5878eba3efc75046bf110d6c70844d92f7a))
* Respect creature HP when given as array in encounters ([244fe03](https://github.com/lslavkov/initiative-tracker/commit/244fe03a1954f6081ac8a26b478441978d35bb6d))
* Respect never rolling initiative when launching encounter ([1ab1271](https://github.com/lslavkov/initiative-tracker/commit/1ab1271ec8a77d500a85e612152b504e36a9abc6))
* respect players & party when launching encounters via API ([146215f](https://github.com/lslavkov/initiative-tracker/commit/146215f5233e88d2e189444bcfbf04f6db9bb088))
* Reverts unintentional breaking Dice Roller change ([5769efe](https://github.com/lslavkov/initiative-tracker/commit/5769efe56310034eeff2c3a65b9d2f82c576efee))
* Roll initiative for creatures added to encounters (close [#81](https://github.com/lslavkov/initiative-tracker/issues/81)) ([fefe218](https://github.com/lslavkov/initiative-tracker/commit/fefe2189f5a5e4417ec7226a7176362b9a4ad309))
* Saved encounters now respect the roll HP setting ([554a430](https://github.com/lslavkov/initiative-tracker/commit/554a430569fc93b1955c08b43474b6a1e535a1f3))
* show player level in settings ([e739698](https://github.com/lslavkov/initiative-tracker/commit/e739698cef1a7ac9d79cc53308b32bc47b7d2fbf))
* Slightly decreases font size on mobile for better readability ([54abd6f](https://github.com/lslavkov/initiative-tracker/commit/54abd6f94a1df1b4f89a701af5d7f4cecce06b2f))
* Starting a new encounter from an Encounter block now correctly creates a new log file ([c6756ce](https://github.com/lslavkov/initiative-tracker/commit/c6756cec4cb0c3a33e4a8d86b9abc011b9556f23))
* Switch to `[@javalent](https://github.com/javalent)` scoped FS module ([c8eeb33](https://github.com/lslavkov/initiative-tracker/commit/c8eeb33756aa988057988684a5c3bcf09eaeaa1a))
* Switch to centrally managed input suggesters ([f5e536e](https://github.com/lslavkov/initiative-tracker/commit/f5e536ee2b4abe73c9b6268aac9c517cf2bfe8b7))
* Update Dice Roller integration ([34a1a15](https://github.com/lslavkov/initiative-tracker/commit/34a1a15f227642834e096d81fb67e0b4865705e4))
* updateCreatureByName no longer has side effects ([a327221](https://github.com/lslavkov/initiative-tracker/commit/a327221c878f9c26c1cefbe73d98eea33eca080b))
* use statblock's bestiary names API vs transforming every time ([e7038d1](https://github.com/lslavkov/initiative-tracker/commit/e7038d16edd48fb40b3f9ddd700f796475f15c34))
